var breathingAlgorithm = {
    ...
    run: function (pfu) {
        ...
        if (this.pfu.breathingEvents) {
            b.breathingEvents = this.pfu.breathingEvents;
        }
...
var sourceNode, analyserNode, javascriptNode, audioStream;
...
function goStream(stream) {
    ...
    javascriptNode.onaudioprocess = function () {
        ...
        for (let value of b.frequencyBin) {
            b.pow += value;
        }
...
var doEvent = function () {
    return {
        stop: function () {
            b.breathingEvents.fireOffEvent();
        },

        start: function () {
            b.breathingEvents.fireOnEvent();
...
// module.exports = {
//     breathingAlgorithm: breathingAlgorithm,
// };